package com.donkeyx.appclient;

import com.alibaba.fastjson.JSON;
import com.alibaba.fastjson.JSONArray;
import com.alibaba.fastjson.JSONObject;
import com.donkeyx.bean.*;
...
public class AppMain {
    ...
    private static JSONObject generateAd() {
        ...
        //contentType 1 商品 2 营销活动
        flag = rand.nextInt(2) + 1;
        appAd.setContentType(flag + "");

        //展示时长 ms
        flag = rand.nextInt(3000) + 1;
        appAd.setDisplayMills(flag + "");
        if(appAd.getContentType().equals("1")){
            //设置商品id
            appAd.setItemId(s_goodsid+"");

        }else {
            //设置营销活动id
            appAd.setActivityId(s_goodsid+"");
        }
